...
const features = [
        ...
        {files.map((f, idx) => (
          <figure
            ...
            className={cn(
              ...
              "transform-gpu blur-[1px] transition-all duration-300 ease-out hover:shadow-sm hover:blur-none"
            )}
          >
            ...
            <blockquote className="mt-2 text-xs text-gray-600">
              {f.body}
            </blockquote>
          </figure>
        ))}
  ...
  },
  {
    ...
    href: "#",
    cta: "Learn more",
    className: "col-span-3 cursor-pointer lg:col-span-2",
    background: (
  ...
  },
  {
    ...
    className: "col-span-3 cursor-pointer lg:col-span-1",
    href: "#",
    cta: "Learn more",
    background: (
      <Calendar
        ...
        className="absolute top-10 right-0 origin-top bg-white border border-gray-400 shadow-2xl text-black scale-75 rounded-md border [mask-image:linear-gradient(to_top,transparent_30%,#000_100%)] transition-all duration-300 ease-out group-hover:scale-90"
      />
    ),
  },
]
