  ...
  return (
    <div className="flex flex-col gap-8 overflow-hidden border-b border-r border-dotted border-zinc-300 bg-white pt-8 pb-6 w-full">
      ...
      <div className="relative flex flex-1 items-center justify-center px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Lines */}
        <div className="absolute inset-x-4 top-0 h-px bg-zinc-200" />
        <div className="absolute inset-x-4 top-1/2 h-px bg-zinc-200" />
        <div className="absolute inset-x-4 bottom-0 h-px bg-zinc-200" />
        ...
        {/* Side fade */}
        <div className="absolute -inset-y-6 left-0 w-[15%] bg-gradient-to-r from-white to-transparent" />
        <div className="absolute -inset-y-6 right-0 w-[15%] bg-gradient-to-l from-white to-transparent" />
