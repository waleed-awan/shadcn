...
export default function LandingSection() {
  return (
    <>
      {/* HERO SECTION */}
      <section className="w-full border-b border-dashed border-gray-300 dark:border-zinc-700 py-10 flex items-center justify-center bg-white dark:bg-black">
        <motion.div
        ...
        >
          ...
          <motion.div variants={fadeUp} className="inline-block mb-8">
            <p className={`${caveat.className} text-lg text-gray-700 dark:text-gray-300`}>
      ...
      {/* CARDS SECTION */}
      <section className="w-full pt-5 px-6 bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[0.6fr_1.4fr] items-center gap-7">
          ...
          >
            <h2 className="text-3xl mb-4 font-semibold text-black dark:text-white">
              Landing Pages
            </h2>
            ...
            <button className="mt-4 px-5 py-2.5 text-black dark:text-white bg-gray-100 dark:bg-zinc-800 hover:bg-gray-200 dark:hover:bg-zinc-700 rounded-lg flex items-center gap-2 text-lg">
              Explore more →
            </button>
          </motion.div>
