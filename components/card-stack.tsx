...
const OrbitAndCards = () => {
  ...
  return (
    <>
      <section className="w-full overflow-hidden border-y border-dashed border-neutral-300 bg-white">
        <div className="mx-auto flex  max-w-[1700px] flex-col lg:flex-row">
          {/* LEFT */}
          <div className="flex flex-1 border-b border-dashed border-neutral-300 lg:border-r lg:border-b-0">
            {/* TEXT */}
            <div className="flex w-full max-w-[390px] flex-col justify-start px-10 py-14">
              <h2 className="text-[30px] leading-[1.15] font-semibold tracking-[-1px] text-black">
            ...
            <div className="relative hidden flex-1 items-center justify-center lg:flex">
              <div className="relative flex h-[360px] w-[360px] items-center justify-center">
                {/* CENTER */}
                <div className="z-20 flex h-12 w-12 items-center justify-center rounded-full bg-black">
                  <Image
                    src="/logo1.png"
                    alt="center"
                    width={20}
                ...
                <OrbitingCircles radius={68} duration={20} path iconSize={34}>
                  {innerImages.map((img, index) => (
                    <div
                      key={index}
                      className="flex h-full w-full items-center justify-center rounded-full border border-neutral-200 bg-white"
                    >
                      <Image
                        src={img}
                        alt=""
          ...
          {/* RIGHT */}
          <div className=" flex-1 flex-col max-w-[460px] justify-between ">
            {/* TEXT */}

            {/* STACK CARDS */}
            <div className="relative mt-8 px-5 py-14 gap-6 items-end justify-center overflow-hidden">
              <div className="">
                <h3 className="text-[30px] leading-[1.15] font-semibold tracking-[-1px] text-black">
              ...
              <div className="relative h-[145px] px-5 py-14 gap-6 w-full max-w-[430px]">
                {cards.map((card, index) => (
                  ...
                  >
                    <div className="rounded-[18px] border border-neutral-200 bg-white shadow-sm">
                      <div className="space-y-3 p-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Ellipsis className="size-3 text-neutral-500" />
                          </div>
                        </div>
