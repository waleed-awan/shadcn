...
export default function DashboardApplicationBlock() {
  return (
    <div className="group flex h-full flex-col justify-between gap-10 bg-white dark:bg-black">
      ...
      <div className="px-4 py-2.5 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <button className="hidden size-7 items-center justify-center rounded-full bg-black text-white dark:bg-white dark:text-black transition-all group-hover:inline-flex hover:bg-black/80 dark:hover:bg-white/80">
      ...
      ">
        ...
        <Image
          ...
          className="
            ...
            rounded-md border border-gray-200 dark:border-white/10 shadow-sm
          "
        />
        ...
        {/* GRADIENTS */}
        <div className="absolute inset-y-0 left-0 w-[15%] bg-gradient-to-r from-white dark:from-black to-transparent" />
        <div className="absolute inset-y-0 right-0 w-[15%] bg-gradient-to-l from-white dark:from-black to-transparent" />
      </div>
    </div>
  )
}
