  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* CARD */}
        <div className="relative overflow-visible rounded-[34px] bg-black px-6 pt-14 pb-20 sm:px-10 sm:pt-16 sm:pb-24 lg:px-16">

          {/* TOP RIGHT SHAPE */}
          <div className="absolute -top-20 -right-20 opacity-[0.12]">
            <svg viewBox="0 0 128 128" className="h-[240px] w-[240px] rotate-90 text-white" fill="none">
          ...
          {/* BOTTOM LEFT SHAPE */}
          <div className="absolute -bottom-20 -left-20 opacity-[0.12]">
            <svg viewBox="0 0 128 128" className="h-[240px] w-[240px] rotate-90 text-white" fill="none">
              <path d="M63.67 24.84V49.38C63.67 57.45 57.13 64 49.06 64H25.2"
                stroke="currentColor" strokeWidth="8" />
              <path d="M64.32 103.15V78.61C64.32 70.54 70.86 64 78.93 64L102.79 64"
          ...
          <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
            ...
            <p className="mt-5 max-w-3xl text-base leading-7 text-white/70 sm:text-lg">
              Want to be the first to know when we add new components, features, blocks, or releases?
            </p>
          </div>

          {/* FORM (ONLY FIXED FOR OVERFLOW) */}
          <form className="absolute left-1/2 top-full z-10 w-full max-w-xl -translate-x-1/2 -translate-y-1/2 px-4">
